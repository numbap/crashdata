...
m <- leaflet(fatalitysites) %>% addTiles %>% addMarkers(popup=~labels, icon = planeIcon) %>% addMarkers(clusterOptions = markerClusterOptions(fatalitysites)) %>% setView(lat = 40.7130, lng = 74.0132, zoom = 4)
